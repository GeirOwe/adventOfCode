...
# source: https://adventofcode.com/2021/day/
# copied from: https://github.com/Bruception/advent-of-code-2021/blob/main/day20/part1.py

import sys

algorithm, _, *image = open(f'{sys.path[0]}/day20_puzzle_input.txt', 'r').read().split('\n')
